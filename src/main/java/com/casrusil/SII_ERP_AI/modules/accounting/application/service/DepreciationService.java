...
import com.casrusil.SII_ERP_AI.modules.accounting.domain.model.FixedAsset;
...
public class DepreciationService {
    ...
    private BigDecimal calculateAcceleratedDepreciation(FixedAsset asset) {
        BigDecimal linearRate = BigDecimal.ONE.divide(
                BigDecimal.valueOf(asset.getUsefulLifeYears()), 4, RoundingMode.HALF_UP);
    ...
    public void recordMonthlyDepreciation(FixedAsset asset, LocalDate periodDate) {
        ...
        lines.add(AccountingEntryLine.debit(DEPRECIATION_EXPENSE_ACCOUNT, monthlyDepreciation));
        lines.add(AccountingEntryLine.credit(ACCUMULATED_DEPRECIATION_ACCOUNT, monthlyDepreciation));
        ...
        AccountingEntry entry = new AccountingEntry(
                ...
                "DEPRECIATION",
                lines,
                com.casrusil.SII_ERP_AI.modules.accounting.domain.model.EntryType.ADJUSTMENT);

...
import com.casrusil.SII_ERP_AI.modules.accounting.domain.event.EntryCorrectedEvent;
...
public class LearningService {
    ...
    public List<ClassificationRule> findApplicableRules(
            com.casrusil.SII_ERP_AI.shared.domain.valueobject.CompanyId companyId,
            String description) {

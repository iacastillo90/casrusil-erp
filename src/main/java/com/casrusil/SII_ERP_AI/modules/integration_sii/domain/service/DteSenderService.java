...
import com.casrusil.SII_ERP_AI.modules.integration_sii.domain.port.out.SiiTokenRepository;
...
public class DteSenderService {
    ...
    private final com.casrusil.SII_ERP_AI.modules.integration_sii.domain.port.out.CafRepository cafRepository;
    private final com.casrusil.SII_ERP_AI.modules.integration_sii.infrastructure.crypto.TedGenerator tedGenerator;
    private final com.casrusil.SII_ERP_AI.modules.integration_sii.infrastructure.xml.DteXmlBuilder dteXmlBuilder;
    private final com.casrusil.SII_ERP_AI.modules.integration_sii.infrastructure.xml.EnvioDteBuilder envioDteBuilder;
    private final com.casrusil.SII_ERP_AI.modules.integration_sii.infrastructure.adapter.out.rest.SiiUploadClient siiUploadClient;
    ...
    public DteSenderService(
            ...
            com.casrusil.SII_ERP_AI.modules.integration_sii.domain.port.out.CafRepository cafRepository,
            com.casrusil.SII_ERP_AI.modules.integration_sii.infrastructure.crypto.TedGenerator tedGenerator,
            com.casrusil.SII_ERP_AI.modules.integration_sii.infrastructure.xml.DteXmlBuilder dteXmlBuilder,
            com.casrusil.SII_ERP_AI.modules.integration_sii.infrastructure.xml.EnvioDteBuilder envioDteBuilder,
            com.casrusil.SII_ERP_AI.modules.integration_sii.infrastructure.adapter.out.rest.SiiUploadClient siiUploadClient) {
    ...
    public boolean sendInvoice(Invoice invoice, CompanyId companyId) {
        ...
        try {
            ...
            com.casrusil.SII_ERP_AI.modules.integration_sii.domain.model.Caf caf = cafRepository

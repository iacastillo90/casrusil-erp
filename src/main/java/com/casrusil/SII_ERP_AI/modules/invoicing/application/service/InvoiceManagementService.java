package com.casrusil.SII_ERP_AI.modules.invoicing.application.service;

import com.casrusil.SII_ERP_AI.modules.invoicing.domain.exception.InvalidInvoiceException;
import com.casrusil.SII_ERP_AI.modules.invoicing.domain.exception.InvoiceAlreadyExistsException;
import com.casrusil.SII_ERP_AI.modules.invoicing.domain.exception.InvoiceNotFoundException;
...
import com.casrusil.SII_ERP_AI.modules.invoicing.domain.port.in.ManageInvoiceUseCase;
...
public class InvoiceManagementService implements ManageInvoiceUseCase, CreateInvoiceUseCase, SearchInvoicesUseCase {
    ...
    public Invoice createInvoice(Invoice invoice) {
        ...
        if (invoiceRepository.existsByCompanyIdAndFolioAndIssuerRut(
                companyId, invoice.getFolio(), invoice.getIssuerRut())) {

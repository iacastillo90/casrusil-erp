package com.casrusil.SII_ERP_AI.modules.invoicing.infrastructure.persistence.adapter;
...
import com.casrusil.SII_ERP_AI.modules.invoicing.infrastructure.persistence.repository.InvoiceJpaRepository;
import com.casrusil.SII_ERP_AI.shared.domain.valueobject.CompanyId;
import com.casrusil.SII_ERP_AI.modules.invoicing.infrastructure.persistence.entity.InvoiceItemEntity;
...
public class InvoiceJpaAdapter implements InvoiceRepository {
    ...
    public boolean existsByCompanyIdAndFolioAndIssuerRut(CompanyId companyId, Long folio, String issuerRut) {
        return invoiceJpaRepository.existsByCompanyIdAndFolioAndIssuerRut(companyId.value(), folio, issuerRut);
    }

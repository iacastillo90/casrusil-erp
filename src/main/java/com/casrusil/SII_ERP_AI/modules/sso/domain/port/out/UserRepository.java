 ...
 * 
 * @see User
 * @see com.casrusil.SII_ERP_AI.modules.sso.infrastructure.adapter.out.persistence.UserJpaAdapter
 * @since 1.0
 */
public interface UserRepository {
     ...
     * @return Optional con el usuario si existe, vacío si no
     * @see com.casrusil.SII_ERP_AI.modules.sso.application.service.AuthService
     */

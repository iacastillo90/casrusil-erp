...
import com.casrusil.SII_ERP_AI.modules.integration_sii.infrastructure.adapter.out.rest.SiiUploadClient;
...
import com.casrusil.SII_ERP_AI.modules.integration_sii.infrastructure.xml.DteXmlBuilder;
import com.casrusil.SII_ERP_AI.modules.integration_sii.infrastructure.xml.EnvioDteBuilder;
...
class DteSenderServiceTest {
    ...
    void shouldSendInvoiceSuccessfully() {
        ...
        when(cafRepository.findActiveForFolio(any(), anyString(), anyLong()))
                .thenReturn(Optional.of(mock(com.casrusil.SII_ERP_AI.modules.integration_sii.domain.model.Caf.class)));
